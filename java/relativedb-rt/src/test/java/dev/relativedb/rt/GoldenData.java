...
final class GoldenData {
    ...
    static boolean classificationCheckpointPresent() {
        try {
            CheckpointResolver.resolve(dev.relativedb.model.ModelConfig.DEFAULT_CLASSIFICATION_MODEL_URI);
            return true;
        } catch (RtException e) {
            return false;
        }
    ...
    static boolean regressionCheckpointPresent() {
        try {
            CheckpointResolver.resolve(dev.relativedb.model.ModelConfig.DEFAULT_REGRESSION_MODEL_URI);
            return true;
        } catch (RtException e) {
            return false;
        }
