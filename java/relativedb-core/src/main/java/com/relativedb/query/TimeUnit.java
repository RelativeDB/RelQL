...
public enum TimeUnit {
    ...
    // Defensive: the parser normalizes calendar units to MONTHS and never emits
    // YEARS in JSON, but the grammar accepts YEAR(S) as a duration literal.
    YEARS(Duration.ofDays(365));
