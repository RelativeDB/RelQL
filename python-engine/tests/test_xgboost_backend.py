...
from relativedb.flat import analyze_flat
from relativedb_engine.xgb import XgboostBackend
...
def test_features_respect_the_anchor(engine, churn_schema):
    ...
    from relativedb_engine.xgb import _features
    a = analyze_flat(REG_QUERY, churn_schema)
    t0 = dt("2026-07-01")
...
def test_peer_rows_never_leak_into_features(churn_schema):
    ...
    from relativedb_engine.xgb import _encode_context
